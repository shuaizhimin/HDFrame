...
public class RequestQueue {
    ...
    /** Network interf for performing requests. */
     ...
     *
     * @param network A Network interf for performing HTTP requests
     * @param threadPoolSize Number of network dispatcher threads to create
     * @param delivery A Delivery interf for posting responses and errors
    ...
    /**
     * A simple predicate or filter interf for Requests, for use by
