...
public class NetworkDispatcher extends Thread {
    ...
    /** The network interf for processing requests. */
     ...
     * @param network Network interf to use for performing requests
	 * @param cache Cache interf to use for writing responses to cache
     * @param delivery Delivery interf to use for posting responses
     */
        ...
        while (true) {
            ...
            try {
                ...
                if(networkResponse!=null && networkResponse.data!=null){
                	HDLog.d(TAG+"-出参：", new String(networkResponse.data));
                }else{
                    HDLog.d(TAG+"-出参：", new String("NULL"));
                }
